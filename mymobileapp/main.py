    ...
    try:
        ...
        page.add(
            ...
            ft.Container(
                padding=20,
                content=ft.Column([
                    ft.Text("糟糕！代码好像遇到了点麻烦，但好在我们把它拦截下来了！", weight=ft.FontWeight.BOLD, size=18),
                    ft.Text("请将下方的错误信息截图发给我：", color=ft.colors.RED_700),
                    ft.Container(
                        padding=10,
